...
export { UegsDebugViewMode, UegsPayloadAppearanceEncoding, UegsPayloadColorSemantic, UegsPayloadMaterialTruthSource, getUegsEditorPreviewContract, getUegsSparkRenderContract, applyUegsSparkViewContract, attachUegsBundle, configureUegsBundleForMesh, getUegsSparkViewContract, inspectUegsRuntimeTelemetry, parseUegsComparisonViewpoint, scaleUegsComparisonViewpointToSceneBounds, loadOptionalUegsBundleFromUrl, parseUegsDebugCaptureSidecar, parseUegsGaussianPayload, parseUegsManifest, parseUegsSceneLightingContract, setUegsAmbientOcclusionEnabled, setUegsBakedShadowEnabled, setUegsDebugViewMode, setUegsDirectLightingEnabled, setUegsSkyLightingEnabled, summarizeUegsBundle, type UegsBundle, type UegsComparisonViewpoint, type UegsDebugCaptureSidecar, type UegsGaussianPayload, type UegsManifest, type UegsRuntimeTelemetry, type UegsSparkRenderContract, type UegsSparkViewContract, type UegsSceneLightingContract, } from './uegs';
